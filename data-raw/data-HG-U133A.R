...
utils::download.file("http://tools.thermofisher.com/content/sfs/supportFiles/hgu133_libraryfile.zip", zip_file)
...
cdf_file <-
    ...
    stringr::str_subset("HG-U133A.cdf")
...
usethis::use_data(`HG-U133A`, overwrite = TRUE)
